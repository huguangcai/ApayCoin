...
import com.ysxsoft.apaycoin.impservice.TicketRecordService;
...
/**
 * 描述： 券纪录
 * 日期： 2018/11/14 0014 10:42
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
public class TicketRecordActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private BalanceMoneyAndTicketRecordAdapter mDataAdapter;
    ...
    private void initView() {
        ...
        mDataAdapter = new BalanceMoneyAndTicketRecordAdapter(this);
...
//        onRefresh();
    ...
    private class PreviewHandler extends Handler {
        private WeakReference<TicketRecordActivity> ref;

        PreviewHandler(TicketRecordActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TicketRecordActivity activity = ref.get();
    ...
    private void getData() {
        ...
        retrofit.create(TicketRecordService.class)
