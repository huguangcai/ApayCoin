...
import kotlinx.android.synthetic.main.modify_login_pwd_layout.*
...
/**
 * 描述： 修改登录密码
 * 日期： 2018/11/7 0007 11:13
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
class ModifyLoginPwdActivity : BaseActivity(), View.OnClickListener {
...
//            checkData()
    ...
    private fun submitData() {
        NetWork.getRetrofit()
                .create(ImpModifyLoginPasswordService::class.java)
                ...
                .subscribe(object : Observer<ModifyLoginPwdBean> {
                    ...
                    override fun onCompleted() {
                        ...
                        if ("0".equals(modifyLoginPwdBean!!.code)) {
                            ...
                            sp.putString("pwd",ed_new_pwd.text.toString().trim())
                            sp.commit()
                            finish()
