...
import com.ysxsoft.apaycoin.adapte.CrowdfundingToStartAdapter;
...
/**
 * 描述： 待开始的fragment
 * 日期： 2018/10/29 0029 16:43
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
public class TostartFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private int type = 1;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private int page=1;
    private CrowdfundingToStartAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new CrowdfundingToStartAdapter(getActivity());
