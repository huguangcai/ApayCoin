...
public class FiveMinuteFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.five_minute_fragment_layout, null);
        initView(view);
//        getData("1");
        return view;
    }
...
//                .getCall(NetWork.getFragmentToken(getActivity()), type)
    ...
    private void initLineChart(LineChart linechart, String gg, String max, String min, final ArrayList<String> times, ArrayList<String> datavalues) {
...
//        // draw points over time
    ...
    private void setData(ArrayList<String> times, ArrayList<String> datavalues) {
