...
import com.ysxsoft.apaycoin.adapte.BuyOrderRunAdapter;
...
/**
 * 描述： TODO 购买订单  待调试
 * 日期： 2018/10/30 0030 11:07
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
public class BuyOrderRunFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private BuyOrderRunAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new BuyOrderRunAdapter(getActivity());
        ...
        mDataAdapter.setOnCancleOrderListener(new BuyOrderRunAdapter.OnCancleOrderListener() {
            @Override
...
//        onRefresh();
    ...
    private void submitData(String oid) {
        NetWork.getRetrofit()
                .create(ImpCancleOrderService.class)
                .getCall(NetWork.getToken(),oid)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<CancleOrderBean>() {
                    private CancleOrderBean cancleOrderBean;

                    @Override
                    public void onCompleted() {
                        Toast.makeText(getActivity(),cancleOrderBean.getMsg(),Toast.LENGTH_SHORT).show();
                        if ("0".equals(cancleOrderBean.getCode())){
                            onRefresh();
                        } if ("2".equals(cancleOrderBean.getCode())) {
                    ...
                    public void onNext(CancleOrderBean cancleOrderBean) {
                        ...
                        this.cancleOrderBean = cancleOrderBean;
                    }
                });
    }

    private class PreviewHandler extends Handler {
//        private WeakReference<BuyOrderRunFragment> ref;
//        PreviewHandler(BuyOrderRunFragment activity) {
...
//                        Toast.makeText(getActivity(),"shadfjasd"+saleBuyOrderBean.getData().size(),Toast.LENGTH_SHORT).show();
