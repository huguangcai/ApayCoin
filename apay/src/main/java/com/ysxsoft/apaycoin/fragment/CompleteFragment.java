...
import com.ysxsoft.apaycoin.adapte.MyOrderCompleteAdapter;
...
import com.ysxsoft.apaycoin.widget.SwipeRefreshView;
...
public class CompleteFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private int page = 1;
    private MyOrderCompleteAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new MyOrderCompleteAdapter(getActivity());
        ...
        mDataAdapter.setOnDeleteListener(new MyOrderCompleteAdapter.OnDeleteListener() {
            @Override
        ...
        NetWork.getRetrofit()
                ...
                .subscribe(new Observer<DeleteOrderBean>() {
                    ...
                    public void onCompleted() {
                        ...
                        if ("0".equals(deleteOrderBean.getMsg())){
                            onRefresh();
