...
import com.ysxsoft.apaycoin.adapte.CrowdfundingCompleteAdapter;
...
/**
 * 描述： 众筹界面的已完成的Fragment
 * 日期： 2018/10/29 0029 17:49
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
public class CrowfundingCompleteFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private int type = 3;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private int page=1;
    private CrowdfundingCompleteAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new CrowdfundingCompleteAdapter(getActivity());
