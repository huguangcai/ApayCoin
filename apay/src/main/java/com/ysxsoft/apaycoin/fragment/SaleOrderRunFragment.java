...
import com.ysxsoft.apaycoin.adapte.SaleOrderRunAdapter;
 ...
 * 公司：郑州亿生信科技有限公司
 */
public class SaleOrderRunFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private SaleOrderRunAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new SaleOrderRunAdapter(getActivity());
        ...
        mDataAdapter.setOnCancleClickListener(new SaleOrderRunAdapter.OnCancleClickListener() {
            @Override
            public void TvCacle(int position) {
...
//        private WeakReference<SaleOrderRunFragment> ref;
//        PreviewHandler(SaleOrderRunFragment activity) {
