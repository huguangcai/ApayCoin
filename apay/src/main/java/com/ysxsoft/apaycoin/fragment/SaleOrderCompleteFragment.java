...
import com.ysxsoft.apaycoin.adapte.SaleOrderCompleteAdapter;
 ...
 * 公司：郑州亿生信科技有限公司
 */
public class SaleOrderCompleteFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LuRecyclerView mRecyclerView = null;
    private SaleOrderCompleteAdapter mDataAdapter;
    ...
    private void initView(View view) {
        ...
        mDataAdapter = new SaleOrderCompleteAdapter(getActivity());
        ...
        mDataAdapter.setOnDeleteListener(new SaleOrderCompleteAdapter.OnDeleteListener() {
            @Override
