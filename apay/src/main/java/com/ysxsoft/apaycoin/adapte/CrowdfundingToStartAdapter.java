 ...
 * 公司：郑州亿生信科技有限公司
 */
public class CrowdfundingToStartAdapter extends ListBaseAdapter<CrowdingFundingBean.DataBean> {
    public CrowdfundingToStartAdapter(Context context) {
        super(context);
    }

    @Override
    public int getLayoutId() {
        return R.layout.crowd_funding_to_start_item_layout;
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        ...
        tv_time.setText(dataBean.getBegin_date());
