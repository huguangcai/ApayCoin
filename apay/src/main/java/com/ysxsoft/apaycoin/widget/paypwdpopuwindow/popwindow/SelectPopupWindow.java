package com.ysxsoft.apaycoin.widget.paypwdpopuwindow.popwindow;
...
import com.ysxsoft.apaycoin.widget.paypwdpopuwindow.adapter.CommonAdapter;
import com.ysxsoft.apaycoin.widget.paypwdpopuwindow.model.KeybordModel;
import com.ysxsoft.apaycoin.widget.paypwdpopuwindow.view.PswView;
...
public class SelectPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    private TextView tv_foget_pay_pwd;
    ...
    private void initViewInputPsw(Activity context) {
        ...
        tv_foget_pay_pwd = (TextView) mMenuView.findViewById(R.id.tv_foget_pay_pwd);
        ...
        tv_foget_pay_pwd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (listener != null) {
                    listener.onForgetPayPwd();
                }
            }
        });
    }
