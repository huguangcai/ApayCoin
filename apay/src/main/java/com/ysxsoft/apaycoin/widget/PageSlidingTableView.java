...
/**
 * 描述：  顶部标签指示器
 * 日期： 2018/10/26 0026 14:43
 * 作者： 胡
 * 公司：郑州亿生信科技有限公司
 */
public class PageSlidingTableView extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
...
//    private int indicator_bottom_line_width = 0;// 指示器底部线条高度
    ...
    public PageSlidingTableView(Context context) {
        super(context);
    }

    public PageSlidingTableView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(TypedArray a) {
        ...
        // indicator height
        indicatorHeight = (int) getDimensionPixelSize(a, R.styleable.MyIndicator_indicato_height, indicatorHeight);
        ...
        // indicator_bottom_line_height 指示器底部线条的高度
...
//        indicator_bottom_line_width = (int) getDimensionPixelSize(a, R.styleable.MyIndicator_indicator_bottom_line_width, indicator_bottom_line_width);
        ...
        // indicator_vertical_line_color  中间分割线的颜色
        ...
        // indicator_vertical_line_h 中间分割线的高
        ...
        // indicator_width  tab宽度,默认填充全屏
        indicator_width = (int) getDimensionPixelSize(a, R.styleable.MyIndicator_indicato_width, indicator_width);
        // indicator_select_textSize 选中字体大小
    ...
    public void setTabTitles(String[] tabTitles) {
        ...
        // 创建底部线
        View line = new View(getContext());
        LinearLayoutCompat.LayoutParams params = new LinearLayoutCompat.LayoutParams(0, indicator_bottom_line_height);
    ...
    public void setOnTabClickListener(PageSlidingTableView.onTabClickListener onTabClickListener) {
        this.onTabClickListener = onTabClickListener;
    }

    @Override
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        LayoutParams ll = (LayoutParams) indicator.getLayoutParams();
        if (currIndex == position) {
            ll.leftMargin = (int) (currIndex * indicator.getMeasuredWidth() + positionOffset * indicator.getMeasuredWidth());
        } else if (currIndex > position) {
            ll.leftMargin = (int) (currIndex * indicator.getMeasuredWidth() - (1 - positionOffset) * indicator.getMeasuredWidth());
        }
